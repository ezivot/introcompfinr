...
The package **introcompfinr** accompanies the book *Introduction to Computational Finance and Financial Econometrics with R* by Eric Zivot. The package contains functions for portfolio analysis, risk management, and financial econometrics.

## Installation

You can install the development version of **introcompfinr** from [GitHub](https://github.com/) with:
...
short sales using matrix algebra computations, and not allowing short sales using
quadratic programming optimization methods. These functions allow
